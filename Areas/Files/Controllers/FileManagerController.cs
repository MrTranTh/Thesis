...
namespace Thesis.Areas.Files.Controllers
{
    [Area("Files")]
    public class FileManagerController : Controller
    {
        ...
        private Connector GetConnector()
        {
            ...
            // _env.ContentRootPath => Truy cập từ Thesis
            string rootDirectory = Path.Combine(_env.ContentRootPath, pathroot);

            // https://localhost:7047/contents/
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                Alias = "Thư mục đăng tải", // Beautiful name given to the root/home folder
